...
const definitionName = "twistedPavilion.gh";
...
const segments_slider = document.getElementById("Segments Number");
...
const columns_slider = document.getElementById("Columns");
columns_slider.addEventListener("mouseup", onSliderChange, false);
columns_slider.addEventListener("touchend", onSliderChange, false);
...
async function compute() {
  ...
  const param2 = new RhinoCompute.Grasshopper.DataTree("Segments Number");
  ...
  const param5 = new RhinoCompute.Grasshopper.DataTree("Density");
  param5.append([0], [density_slider.valueAsNumber]);

  const param6 = new RhinoCompute.Grasshopper.DataTree("Columns Radius");
  param6.append([0], [columns_slider.valueAsNumber]);
